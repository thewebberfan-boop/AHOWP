...
const supplementedFigures: FigureEntry[] = [
  { id: "eriugena", zh: "约翰·司各脱·爱留根纳", en: "John Scottus Eriugena", imagePath: publicAssetPath("/visual-archive/figures/eriugena.jpg"), sourcePage: "https://commons.wikimedia.org/wiki/File:Johannes-Scotus-Erigena.jpg", license: "Copyrighted free use", artist: "Unknown", representationCaution: "中世纪人物的后世插图不是写实肖像，应作为视觉识别符号使用。" },
