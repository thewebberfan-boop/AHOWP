...
export const russellStructureStages: RussellStructureStage[] = [
  ...
  },
  {
    ...
    schools: [
      { id: "cynic-sceptic", title: "犬儒主义与怀疑主义", english: "Cynicism and Scepticism", response: "分别通过摆脱社会依赖或悬置判断，减少外部世界对人的支配。", sharedPattern: "把哲学直接转化为心理与生活训练。", chapterIds: ["b1-26"], philosophers: [person("diogenes", "第欧根尼", "Diogenes", [], "以激进简朴反抗社会习俗。"), person("pyrrho", "皮浪", "Pyrrho", [], "以悬置判断追求不受扰动。") ] },
      { id: "epicurean", title: "伊壁鸠鲁派", english: "Epicureanism", response: "通过理解自然、限制欲望和经营友谊消除恐惧。", sharedPattern: "原子论自然观与节制的快乐伦理。", chapterIds: ["b1-27"], philosophers: [person("epicurus", "伊壁鸠鲁", "Epicurus", [], "把无痛苦与心灵宁静设为生活目标。") ] },
