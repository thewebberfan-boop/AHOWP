...
export const historyStages: HistoryStage[] = [
  {
    ...
    title: "城邦与自然的发现",
    subtitle: "前苏格拉底哲学",
    transition: "神话与传统宇宙叙事之中，出现可讨论、可推理的自然解释",
    ...
    chain: [
      ...
      { label: "共同转向", text: "把部分现象转为自然内部的原因问题", kind: "response" },
      { label: "核心分歧", text: "变化是真实，还是感官幻象？", kind: "oppose" },
      { label: "留下的问题", text: "理性与经验何者更可靠", kind: "inherit" },
    ],
    responses: [
      { id: "milesians", title: "寻找物质本原", figures: "泰勒斯、阿那克西曼德、阿那克西美尼", region: "米利都 / 爱奥尼亚", answer: "世界的多样性可以由一种或少数自然本原解释。", method: "观察、类比与自然假说", difference: "没有突然抛弃神话语境，却更系统地要求用自然内部、可争论的原则解释世界。", noteCue: "Water is the original substance / the world was evolved", chapterIds: ["b1-02"] },
  ...
  },
  {
    ...
    title: "帝国世界与个人伦理",
    subtitle: "亚历山大以后的哲学",
    transition: "城邦政治与帝国秩序交叠 → 在公共角色与个人操练之间重定伦理",
    world: ["城邦仍持续运作，但其自主权受马其顿和继业者王国限制", "跨地域王国改变公民参与和政治行动的尺度", "希腊、埃及、波斯与东方文化加速接触"],
    carrier: "跨地域学派、宫廷、城市教师与个人修习共同体",
    commonQuestion: "当公共生活的尺度与控制条件发生变化，个人怎样在共同体角色、宇宙秩序与自我操练之间获得安定和自由？",
    chain: [
      { label: "结构变化", text: "城邦公民身份与王国、帝国秩序并存", kind: "condition" },
      { label: "目标重排", text: "公共义务与个人安定重新组合", kind: "response" },
    ...
    responses: [
      ...
      { id: "stoics", title: "在因果秩序中实践德性", figures: "季蒂昂的芝诺、塞涅卡、爱比克泰德、马可·奥勒留", region: "从希腊化东方到罗马", answer: "真正的善在德性、判断与同意；外物不决定幸福，却仍需在具体角色中恰当使用。", method: "判断训练、恰当行动与普遍自然法；爱比克泰德突出控制区分", difference: "不必退出世界，而是在家庭、城市和更广共同体中重定自由与责任。", noteCue: "individual life is good when it is in harmony with Nature", chapterIds: ["b1-28"] },
    ],
