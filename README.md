...
另设“问题图谱”作为跨人物的逻辑阅读层：节点只有观察、问题和答案，哲学家只作为参与者附着其上；有向边显式保存一对多和多对多的提出、回应与再生关系。当前谱系以 826 个节点和 975 条关系覆盖泰勒斯至罗素，完整纳入三卷 76 章与现有 82 位人物。最后六章由功利主义的共同后果与自由修正进入马克思的生产关系批判，再经柏格森的绵延、詹姆斯和杜威的实用探究，抵达弗雷格—罗素的现代逻辑与分析方法；终端保留逻辑、经验、历史、生活体验和公共纠错如何协作的开放问题。观察领域只在节点详情中解释；历史事件或社会变化确实改变问题条件时，可由观察节点进入历史概览并返回原阅读位置。
