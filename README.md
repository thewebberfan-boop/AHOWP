...
问题图谱保留全部原子节点与稳定 ID，同时提供“导览／主干／标准／完整／研究”五档全图阅读密度。另以“自我”开始试验主题多分辨率阅读：从5个主矛盾逐级展开为10个主要转折、20个关键接口、50个原子地标和全部相关节点；总结节点明确标记为本站学习重构，并可下钻回稳定原子节点。后续主题按“方法—自然—自我—社会—终极”扩展并支持多选。
