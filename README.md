...
另设“问题图谱”作为跨人物的逻辑阅读层：节点只有观察、问题和答案，哲学家只作为参与者附着其上；有向边显式保存一对多和多对多的提出、回应与再生关系。当前谱系以 556 个节点和 659 条关系覆盖泰勒斯至贝克莱：第一卷全部 30 章与现有 29 位第一卷人物、第二卷全部 15 章和 24 位人物，以及第三卷第一至十六章的马基雅维利、伊拉斯谟、莫尔、路德、哥白尼、开普勒、伽利略、培根、霍布斯、笛卡尔、斯宾诺莎、莱布尼茨、洛克和贝克莱；休谟作为下一章接口进入。观察领域只在节点详情中解释；历史事件或社会变化确实改变问题条件时，可由观察节点进入历史概览并返回原阅读位置。

问题图谱保留全部原子节点与稳定 ID，同时提供“导览／主干／标准／完整／研究”五档阅读密度：低密度用历史时期与问题家族辨认全局，标准档折叠连续的一进一出论证链，完整档恢复全部节点，研究档在左侧集中核对边标签和证据。任一节点还可切换一跳或两跳局部聚焦；解释边界与常见误读放在左侧详情，不再额外占用主图节点。
...
- `app/problem-map-modern-data.ts`：第三卷问题图谱汇总、早期近代阶段和来源；当前整体覆盖第一至十六章。
